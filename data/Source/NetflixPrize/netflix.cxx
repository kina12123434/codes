...
constexpr int ROW = 480189;
constexpr int COL = 17770;
constexpr int SIZE = 100480507;

//Eu個以上評価しているユーザに絞る
constexpr int Eu = 2000;
//Ei人以上に評価されているアイテムに絞る
constexpr int Ei = 130;

const std::string data_file1 = "ratings_rowmajor.txt";
const std::string data_file2 = "ratings_colmajor.txt";

int main(void){
  std::cout << "Eu: " << Eu << ", Ei: " << Ei << std::endl;
  //各ユーザが評価したアイテム数
  ...
  int uu=0,ii=0,tmpu=0,tmpi=0,x=0;
  while(1){
    int usersizesum=0;
    for(int k=0;k<ROW;k++){
      //削るべきユーザであれば
